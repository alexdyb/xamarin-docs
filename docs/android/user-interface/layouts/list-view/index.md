...
[`ListView`](https://developer.xamarin.com/api/type/Android.Widget.ListView/). Make sure that you change Build Action property for this file to Android Resouce.
